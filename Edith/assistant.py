...
ctypes.windll.kernel32.SetConsoleTitleW("Simple Virtual Assistant By Karthik Vallabhaneni ")
os.system('cls')
...
def takecommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            return "Could you please say it again"
        return text
...
while running:
    ...
    if 'good evening' in text or 'good morning' in text or 'good afternoon' in text:
        ...
        if 'google' in answer3:
            ...
            wb.open('https://www.youtube.com/results?search_query=' + abc3)
        ...
        speak('I was created by Karthik Vallabhaneni')
    elif text == 'introduce yourself' or text == 'who are you' or text == 'tell me something about yourself' or 'introduce yourself' in text:
        speak(
            'I am edith. You can know me as personal computer and virtual assistant of Karthik Vallabhaneni. I was created by using python. I am 1 day old. currently, I am in development stage.')
    elif text == 'tell me something about mr Karthik' or text == 'tell me something about Karthik Vallabhaneni' or text == 'who is Karthik Vallabhaneni' or text == 'who is mr chandola' or text == 'who is himanshu':
        speak(
            'Karthik Vallabhaneni is a student. As a practice and a small project, he created me and I am talking to you.')
    ...
    elif text == 'quit' or text == 'edith bye' or text == 'edith quit' or text == 'bye' or 'bye' in text or 'quit' in text:
